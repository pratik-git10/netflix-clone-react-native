...
const Header = () => {
  ...
  return (
    <div className="bg-neutral-400 shadow-md shadow-black border-black max-w-sm md:max-w-4xl mx-auto sticky top-0 m-2 backdrop-blur-3xl rounded-md flex-1 flex-nowrap">
